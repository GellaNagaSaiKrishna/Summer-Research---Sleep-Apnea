...
parser.add_argument('--spect_freq', type=int, default=48, help='Number of wavelet scales')
parser.add_argument('--spect_time', type=int, default=3000, help='Time dimension of wavelet transform')
